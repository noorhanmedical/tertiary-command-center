...
export default function EngagementCenterPage() {
  return (
    <div className="relative left-1/2 flex h-full w-screen -translate-x-1/2 flex-col bg-[#EEF1F6]">
      <header className="sticky top-0 z-30 w-screen border-b border-slate-800 bg-[#101115] text-white">
