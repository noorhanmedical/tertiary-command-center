...
export const ROLE_DOCK_CONFIGS: RoleDockConfig[] = [
  {
    role: "admin",
    defaultApps: ["home", "nova", "metrics", "phone", "team-ops", "plexus-tasks", "schedule", "plexus-nucleus"],
    lockedApps: ["home", "nova"],
    optionalApps: ["messages", "patients", "documents", "engagement", "plexus-iq", "billing", "whiteboard", "games"],
  },
  {
    role: "pcs",
    defaultApps: ["home", "nova", "metrics", "phone", "plexus-tasks", "schedule", "team-ops", "plexus-nucleus"],
    lockedApps: ["home", "nova"],
    optionalApps: ["messages", "patients", "documents", "whiteboard", "games"],
  },
  {
    role: "acs",
    defaultApps: ["home", "nova", "schedule", "plexus-tasks", "phone", "metrics", "team-ops", "plexus-nucleus"],
    lockedApps: ["home", "nova"],
    optionalApps: ["messages", "patients", "documents", "whiteboard", "games"],
  },
  {
    role: "scheduler",
    defaultApps: ["home", "nova", "phone", "plexus-tasks", "schedule", "metrics", "team-ops", "plexus-nucleus"],
    lockedApps: ["home", "nova"],
    optionalApps: ["messages", "patients", "documents", "whiteboard", "games"],
  },
  {
    role: "clinician",
    defaultApps: ["home", "nova", "schedule", "plexus-tasks", "patients", "plexus-nucleus", "metrics", "documents"],
    lockedApps: ["home", "nova"],
    optionalApps: ["messages", "phone", "whiteboard", "games"],
  },
  {
    role: "biller",
    defaultApps: ["home", "nova", "billing", "plexus-tasks", "documents", "schedule", "metrics", "plexus-nucleus"],
    lockedApps: ["home", "nova"],
