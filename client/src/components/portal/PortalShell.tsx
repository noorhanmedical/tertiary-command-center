  ...
  return (
    <div className="fixed inset-0 z-[80] flex flex-col overflow-hidden bg-white" data-testid={`portal-${role}`}>
      ...
      <div className="relative flex-1 overflow-hidden">
        ...
        <div
          className={`absolute left-4 top-4 bottom-4 z-20 rounded-[28px] border border-white/20 text-white shadow-[0_24px_70px_rgba(15,23,42,0.42)] backdrop-blur-2xl transition-all duration-300 ${
            leftRailCollapsed
        ...
        <div
          className={`absolute right-4 top-4 bottom-4 z-20 rounded-[28px] border border-white/20 text-white shadow-[0_24px_70px_rgba(15,23,42,0.42)] backdrop-blur-2xl transition-all duration-300 ${
            rightRailCollapsed
              ? "w-10 bg-[rgba(72,99,160,0.10)]"
        ...
        {aiMinimized ? (
          <button
            ...
            className="absolute bottom-5 right-5 z-30 inline-flex h-14 w-14 items-center justify-center rounded-full border border-white/60 bg-white/70 shadow-[0_18px_60px_rgba(15,23,42,0.18)] backdrop-blur-xl hover:bg-white"
            data-testid="button-ai-fab"
          >
            <Sparkles className="h-5 w-5 text-indigo-600" />
          </button>
        ) : (
          <div className="absolute bottom-5 right-5 z-30 w-[340px] rounded-[24px] border border-white/60 bg-white/70 shadow-[0_18px_60px_rgba(15,23,42,0.18)] backdrop-blur-xl" data-testid="floating-ai-panel">
