...
export function PatientPdfActions({
  ...
  // Icon-only mode renders two small circular buttons; used inside
  // shared `PatientCard` so the action rail stays compact. Text mode
  // is still available for places that have room (e.g. clinic-detail
  // packet headers).
  if (iconOnly) {
    return (
      <div
