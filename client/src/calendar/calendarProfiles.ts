...
export const CALENDAR_PROFILES: Record<CalendarProfileId, CalendarProfile> = {
  ...
  ancillaryCareSpecialist: {
    id: "ancillaryCareSpecialist",
    label: "Ancillary Care Specialist",
    description:
      "Team-member day calendar consolidating the former Technician + Liaison capabilities — clinic visits, ancillary execution, same-day adds, and procedure-complete actions all in one view.",
    defaultView: "day",
    defaultFilters: [
      "clinicVisits",
      "qualifiedVisitPatients",
