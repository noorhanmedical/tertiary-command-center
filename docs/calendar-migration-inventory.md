...
| `client/src/components/outreach/TriClinicCalendar.tsx` <br/> `client/src/components/outreach/ExpandedSectionView.tsx` <br/> `client/src/pages/outreach-scheduler-portal.tsx` <br/> *(host: Patient Care Specialist Portal, `/patient-care-specialist-portal`)* | `patientCareSpecialist`     | pending |
| `client/src/components/clinic-calendar.tsx` (MiniCalendar / SlotGrid) <br/> `client/src/components/portal/PortalShell.tsx` (MonthlyMiniCalendar) <br/> *(host: Ancillary Care Specialist Portal, `/ancillary-care-specialist-portal`)* | `technician`                | pending |
