...
export const PATIENT_DIRECTORY_SECTIONS: PatientDirectorySectionDef[] = [
  ...
  },
  {
    sectionId: "documents",
    label: "Documents",
    description: "Consent forms, screening forms and reports.",
    defaultVisible: true,
    defaultAllowedRoles: roles("full", "full", "summary"),
    defaultAccessLevel: "full",
    category: "workflow",
  ...
  {
    sectionId: "ad-automation",
    label: "Ad Automation",
    description: "Outreach channel eligibility and campaigns.",
    defaultVisible: true,
  ...
  {
    sectionId: "execution-cases",
    label: "Execution Cases",
    description: "Active outreach engagement cases.",
    defaultVisible: true,
    defaultAllowedRoles: roles("summary", "hidden", "full"),
    defaultAccessLevel: "full",
    category: "outreach",
  ...
  },
  {
    ...
    description: "Chronological activity across the patient's record.",
    defaultVisible: true,
    defaultAllowedRoles: roles("full", "full", "full"),
    defaultAccessLevel: "full",
    category: "outreach",
